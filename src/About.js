  ...
  render() {
    return (
        <div className="About">
            ...
            <br></br>
            <a href="https://www.linkedin.com/in/bgubitosa/" target="_blank">Follow Me on Linkedin</a>
            <br></br>
            <a href="https://github.com/brandongubitosa" target="_blank">Here is My GitHub Repo</a>
        </div>
    ) 
  }
}
